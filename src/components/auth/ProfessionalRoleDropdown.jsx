...
import { professionalRoles } from "@/constants/auth";
import { CheckCircle2 } from "lucide-react";

export default function ProfessionalRoleDropdown({
  value,
  onChange,
  onFocus,
  onBlur,
  ...
  const selectedRole = professionalRoles.find((r) => r.value === value);
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        >
          {value ? (
            ...
            <span>Select your professional role</span>
          )}
        </button>
