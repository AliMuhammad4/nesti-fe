...
export const API_ENDPOINTS = {
  ...
  client: {
    ...
    agentInquiryPropertyImages: withBaseUrl("/api/client/agent-inquiry/property-images"),
    agentInquiry: withBaseUrl((professionalId) => `/api/client/professionals/${professionalId}/agent-inquiry`),
    lawyerInquiry: withBaseUrl((professionalId) => `/api/client/professionals/${professionalId}/lawyer-inquiry`),
    mortgageBrokerInquiry: withBaseUrl((professionalId) => `/api/client/professionals/${professionalId}/mortgage-broker-inquiry`),
  ...
  proChat: {
    ...
    clientGroups: withBaseUrl("/api/pro-chat/client/groups"),
    clientGroupDetail: withBaseUrl((id) => `/api/pro-chat/client/groups/${id}`),
    clientGroupDelete: withBaseUrl((id) => `/api/pro-chat/client/groups/${id}`),
    clientGroupMembers: withBaseUrl((id) => `/api/pro-chat/client/groups/${id}/members`),
    clientGroupMember: withBaseUrl((id, userId) => `/api/pro-chat/client/groups/${id}/members/${userId}`),
    clientGroupLeave: withBaseUrl((id) => `/api/pro-chat/client/groups/${id}/leave`),
    clientGroupRejoinRequest: withBaseUrl((id) => `/api/pro-chat/client/groups/${id}/rejoin-request`),
    clientGroupRejoinRequests: withBaseUrl((id) => `/api/pro-chat/client/groups/${id}/rejoin-requests`),
    clientGroupRejoinResolve: withBaseUrl((id, userId, action) => `/api/pro-chat/client/groups/${id}/rejoin-requests/${userId}/${action}`),
    ...
    threadCallToken: withBaseUrl((id) => `/api/pro-chat/threads/${id}/call-token`),
